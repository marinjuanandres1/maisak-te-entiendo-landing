...
export default function Message() {
  return (
    <section id="mensaje" className="relative px-5 py-16 sm:px-6 sm:py-24">
      {/* Subtle ambient glow */}
      <div className="pointer-events-none absolute left-1/2 top-1/2 h-[400px] w-[400px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(circle,rgba(95,7,19,0.06),transparent_70%)]" />
      ...
      >
        {/* Invitation card */}
        <div className="rounded-2xl border border-burgundy/15 bg-gradient-to-b from-[#140606] to-[#0f0404] px-6 py-10 shadow-[0_8px_40px_rgba(0,0,0,0.5)] sm:px-10 sm:py-14">
          ...
          <div className="mx-auto max-w-[28ch] text-center sm:max-w-[34ch]">
            <p className="font-body text-sm font-light italic leading-[1.8] text-white-soft/85 sm:text-base">
              Familia, les tengo una invitación pa&apos; los que quieran caer a
            ...
            <p className="mt-5 font-body text-sm font-light italic leading-[1.8] text-white-soft/85 sm:mt-6 sm:text-base">
              Quiero verlos de cerca, compartir un rato, y cantar juntos.
            </p>
