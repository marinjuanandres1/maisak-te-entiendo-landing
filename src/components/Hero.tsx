  ...
  return (
    <section className="relative flex min-h-screen min-h-[100dvh] flex-col items-center justify-center overflow-hidden px-4 py-16 sm:px-6 sm:py-24">
      ...
      <div className="pointer-events-none absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
        <div
          className="h-[280px] w-[280px] rounded-full border border-gold/10 sm:h-[360px] sm:w-[360px] md:h-[560px] md:w-[560px]"
          style={{ animation: "pulse-ring 6s ease-in-out infinite" }}
        />
      </div>
      <div className="pointer-events-none absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
        <div
          className="h-[200px] w-[200px] rounded-full border border-gold/5 sm:h-[280px] sm:w-[280px] md:h-[440px] md:w-[440px]"
